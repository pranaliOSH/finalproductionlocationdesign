            ...
            <div className="mb-2">
              ...
              {facilityData.isClaimed && (
                <div className="flex items-center gap-2 mt-3">
                  ...
                  <InfoTooltip
                    description="This profile has been claimed and verified by the production location's owner or manager. Claimed data is considered the most authoritative source."
