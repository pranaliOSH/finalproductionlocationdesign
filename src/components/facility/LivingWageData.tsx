    ...
    <>
      ...
      <div className="mt-6 pt-4 border-t border-border bg-muted/50 -mx-4 px-4 py-3 rounded-md space-y-2">
        <p className="text-base text-muted-foreground">
          <span className="font-bold text-primary">Disclaimer:</span> Wage benchmarks are estimates based on regional data and may not reflect actual wages paid at this facility.
        </p>
      </div>
    </>
  );
