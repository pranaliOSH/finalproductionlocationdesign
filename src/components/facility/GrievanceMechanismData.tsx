  ...
  <>
       ...
       <div className="mt-6 pt-4 border-t border-border bg-muted/50 -mx-4 px-4 py-3 rounded-md space-y-2">
           <p className="text-base text-muted-foreground">
             <span className="font-bold text-primary">Disclaimer:</span> Due to the sensitive nature of this issue area, this set of partner data is actively in development. Please <a href="https://info.opensupplyhub.org/contact-us" target="_blank" rel="noopener noreferrer" className="underline hover:text-foreground transition-colors">contact us</a> if you have feedback to share.
           </p>
           <p className="text-base text-muted-foreground">
             Open Supply Hub <strong>does not operate a grievance mechanism</strong> and cannot receive or investigate complaints. Datasets displayed include <strong>only organizations that have opted to share additional information</strong> about this location on Open Supply Hub at this time and do not reflect all available mechanisms, including third party, internal, and government or state-based processes. Open Supply Hub <strong>does not verify the effectiveness, accessibility, or outcomes of any listed mechanism</strong>. The presence of grievance mechanism-related information on Open Supply Hub is <strong>not an endorsement</strong> of that mechanism or encouragement to prioritize it over non-listed mechanisms or existing legal structures, and should not be assumed to necessarily be an indicator of positive working conditions or effective access to remedy.
           </p>
        </div>
     </>;
