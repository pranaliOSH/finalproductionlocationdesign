  ...
  <>
       ...
       <div className="mt-6 pt-4 border-t border-border bg-muted/50 -mx-4 px-4 py-3 rounded-md space-y-2">
          <p className="text-base text-muted-foreground">
            <span className="font-bold text-primary">Disclaimer:</span> Disclaimer: Open Supply Hub does not operate a grievance mechanism and cannot receive or investigate complaints. Datasets listed here are only inclusive of organizations who have opted into sharing certain additional information on Open Supply Hub at this time and do not reflect all available mechanisms, including other third party, internal, and government or state-based processes. Open Supply Hub does not verify the effectiveness, accessibility, or outcomes of any listed mechanism. The presence of grievance mechanism-related information on Open Supply Hub is not an endorsement of and should not be assumed to necessarily be an indicator of positive working conditions or effective access to remedy.
          </p>
        </div>
     </>;
