  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border-t-2 border-primary pt-6">
        ...
        <p className="text-base text-muted-foreground">Learn More <a href="https://info.opensupplyhub.org/data-integrations" target="_blank" rel="noopener noreferrer" className="underline hover:text-foreground transition-colors">Learn more about how it works and how to use it.</a></p>
      </div>
