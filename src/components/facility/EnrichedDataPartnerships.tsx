  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border-t-2 border-primary pt-6">
        ...
        <p className="text-base text-muted-foreground">The following information is provided by third-party partners who host additional social or environmental data related to this production location, its context, and/or its operations. Learn more about how it works and how to use it.            </p>
      </div>
