        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-3">
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <div className={`overflow-hidden transition-all duration-200 ${isDataSourcesOpen ? "max-h-24 opacity-100 mt-1" : "max-h-0 opacity-0"}`}>
                <p className="text-sm text-muted-foreground">General information and operational details shared by production location management</p>
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <div className={`overflow-hidden transition-all duration-200 ${isDataSourcesOpen ? "max-h-24 opacity-100 mt-1" : "max-h-0 opacity-0"}`}>
                <p className="text-sm text-muted-foreground">Additional social or environmental information shared by third party platforms   </p>
