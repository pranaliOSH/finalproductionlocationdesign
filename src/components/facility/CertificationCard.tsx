    ...
    <>
      ...
      <div className="mt-6 pt-4 border-t border-border bg-muted/50 -mx-4 px-4 py-3 rounded-md space-y-2">
        <p className="text-base text-muted-foreground">
          <span className="font-bold text-primary">Disclaimer:</span> Certification status may change. Always verify validity dates and check directly with certifying bodies for the most current information.
        </p>
      </div>
    </>
  );
